	...
	if(choice==1)
	 {
		...
		if(pchoice>=1 && pchoice<=5)
		{
			...
			switch(pchoice1)
			{
			case 1: choice = 11*quantity;
			break;

			case 2: choice = 14*quantity;
			break;

			case 3: choice = 16*quantity;
			break;
	 ...
	 else if(choice==2)
	 {
		...
		if(pchoice1>=1 && pchoice1<=3)
		{
			...
			switch(pchoice1)
			{
			case 1: choice = 2*quantity;
			break;

			case 2: choice = 4*quantity;
			break;

			case 3: choice = 6*quantity;
			break;
	...
	else if(choice==3)
	 {
		...
		if(pchoice1>=1 && pchoice1<=3)
		{
			...
			case 2: choice = 3*quantity;
			break;

			case 3: choice = 4*quantity;
			break;
	 ...
	 else if(choice==4)
	 {
		...
		if(pchoice1>=1 && pchoice1<=3)
		{
			...
			switch(pchoice1)
			{
			case 1: choice = 1*quantity;
			break;

			case 2: choice = 2*quantity;
			break;

			case 3: choice = 3*quantity;
			break;
